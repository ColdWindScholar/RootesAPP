...
import com.root.krscript.BgTaskThread
import com.root.krscript.HiddenTaskThread
import com.root.krscript.R
import com.root.krscript.TryOpenActivity
import com.root.krscript.config.IconPathAnalysis
import com.root.krscript.executor.ScriptEnvironmen
import com.root.krscript.model.*
import com.root.krscript.shortcut.ActionShortcutManager
                ...
                Thread {
                    ...
                    handler.post {
                        ...
                        if (customRunner != true) {
                            ...
                            dialogView.findViewById<View>(com.root.common.R.id.btn_cancel).setOnClickListener {
                                try {
                                    dialog!!.dismiss()
                                } catch (ex: java.lang.Exception) {
                                }
                            }
                            dialogView.findViewById<View>(com.root.common.R.id.btn_confirm).setOnClickListener {
                                try {
                                    val params = render.readParamsValue(actionParamInfos)
                                    actionExecute(action, script, onExit, params)
                                    dialog!!.dismiss()
