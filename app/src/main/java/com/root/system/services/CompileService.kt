package com.root.system.services
        ...
        if (compile_method == "reset") {
            ...
            for (packageName in packageNames) {
                if (true) {
                    ...
                    cmdBuilder.append("am broadcast -n com.root.system/com.root.system.ReceiverCompileState --ei current $current --ei total $total --es packageName $packageName\n")
            ...
            cmdBuilder.append("am broadcast -n com.root.system/com.root.system.ReceiverCompileState --ei current $total --ei total $total --es packageName OK\n")
