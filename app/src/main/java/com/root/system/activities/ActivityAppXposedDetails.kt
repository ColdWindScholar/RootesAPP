...
import com.root.ui.IntInputFilter
import com.root.vaddin.IAppConfigAidlInterface
import com.root.system.R
import com.root.system.databinding.ActivityAppXposedDetailsBinding
...
class ActivityAppXposedDetails : ActivityBase() {
    ...
    fun getAddinVersion(): Int {
        ...
        try {
            ...
            val info = manager.getPackageInfo("com.root.vaddin", 0)
    ...
    private fun checkXposedState() {
        ...
        try {
            vAddinsInstalled = packageManager.getPackageInfo("com.root.vaddin", 0) != null
