...
import com.root.krscript.config.PageConfigReader
import com.root.krscript.config.PageConfigSh
...
import com.root.krscript.ui.ActionListFragment
        ...
        if (intent.extras != null) {
            ...
            if (extras != null && (extras.containsKey("page") || extras.containsKey("shortcutId"))) {
                ...
                if (page != null) {
                    ...
                    Toast.makeText(this, "发生逆天的XML错误代码", Toast.LENGTH_SHORT).show()
                    finish()
                }
            }
        }
