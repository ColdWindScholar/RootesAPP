...
import com.root.library.basic.InputMethodApp
import com.root.library.basic.LauncherApps
import com.root.library.calculator.Flags
import com.root.scene_mode.AppSwitchHandler
import com.root.scene_mode.AutoClickInstall
import com.root.scene_mode.AutoSkipAd
import com.root.store.SpfConfig
import com.root.utils.AutoSkipCloudData
import com.root.system.popup.FloatLogView
...
class AccessibilityScenceMode : AccessibilityService(), IEventReceiver {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        */
        ...
        if (packageName != null) {
            when {
                packageName == "com.root.gesture" || packageName == "com.root.filter" -> {
                    return
                }
                /*
                ...
                */
                // packageName == "com.root.system" -> return
        ...
        if (effectiveWindows.isNotEmpty()) {
            try {
                ...
                for (window in effectiveWindows) {
                    ...
                    if (wp == null || wp == "android" || wp == "com.android.systemui" || wp == "com.miui.freeform" || wp == "com.root.gesture" || wp == "com.root.filter" || wp == "com.android.permissioncontroller") {
                        continue
                    }
                    */
    ...
    private fun destroy() {
        ...
        if (appSwitchHandler != null) {
            ...
            Toast.makeText(applicationContext, "辅助服务已关闭！", Toast.LENGTH_SHORT).show()
            // disableSelf()
            stopSelf()
        }
    }
