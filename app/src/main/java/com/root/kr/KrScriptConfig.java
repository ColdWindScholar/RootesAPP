...
public class KrScriptConfig {
    ...
    private final static String TOOLKIT_DIR_DEFAULT = "file:///android_asset/usr";
    ...
    private final String BEFORE_START_SH_DEFAULT = "file:///android_asset/kr-script/Start.sh";
