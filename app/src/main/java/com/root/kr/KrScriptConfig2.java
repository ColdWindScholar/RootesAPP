...
public class KrScriptConfig2 {
    private static final String ASSETS_FILE = "file:///android_asset/plugins/";

    private final static String TOOLKIT_DIR = "toolkit_dir";
    private final static String TOOLKIT_DIR_DEFAULT = "/data/data/com.root.system/files/plugins/usr";
    ...
    private final String EXECUTOR_CORE_DEFAULT = "/data/data/com.root.system/files/plugins/executor.sh";
    private final String PAGE_LIST_CONFIG_DEFAULT = "";
    private final String FAVORITE_CONFIG_DEFAULT = "";
    private final String ALLOW_HOME_PAGE_DEFAULT = "1";
    private final String BEFORE_START_SH_DEFAULT = "/data/data/com.root.system/files/plugins/Start.sh";
