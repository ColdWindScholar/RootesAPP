...
import com.root.common.shell.KeepShellAsync
import com.root.common.shell.KeepShellPublic
import com.root.library.shell.LocationHelper
...
class SystemScene(private var context: Context) {
    ...
    private fun switchLowPowerModeShell(powersave: Boolean) {
        ...
        if (lowPowerModeShell!!.isEmpty()) {
            lowPowerModeShell = com.root.common.shared.FileWrite.writePrivateShellFile("addin/power_save_set.sh", "addin/power_save_set.sh", context)
        }
